...
function LoadMoreDemo() {
    ...
    return (
        <div className="panel">
            ...
            <div className="hint">
                Scraper kamu harus cari <code>#load-more-btn</code>, klik berulang sampai disable, lalu kumpulkan hasil dari
                <code>#load-more-list</code> lintas klik — bukan cuma baca satu snapshot.
            </div>
        </div>
    );
}
